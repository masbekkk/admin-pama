                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="v_d_c_master_id" class="form-control select2" id="vdc_master">
                            ...
                            @foreach ($catalogVDC as $value)
                                <option {{ $vDCClaim['v_d_c_master_id'] == $value->id ? 'selected' : '' }}
                        ...
                        <select name="unit_id" class="form-control select2" id="unit">
                            ...
                            @foreach ($units as $value)
                                <option value="{{ $value->id }}"
                                    {{ $vDCClaim['unit_id'] == $value->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="installation_date" name="installation_date" class="form-control" required
                            value="{{ $vDCClaim['installation_date'] }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status_claim" class="form-control admin">
                            ...
                            <option {{ $vDCClaim['status_claim'] == 'reject' ? 'selected' : '' }} value="reject">Reject
                            </option>
                        </select>
                    </div>
